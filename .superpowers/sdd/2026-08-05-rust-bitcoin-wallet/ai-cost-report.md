...
| **Total (retroactive est. + Phase 1 closure + wallet-import + Story 11 + testcontainers + Stories 5/6 send + fee-rate)** | | **~3.70M** | **~1.22M** | | **~$21.67** | Subject to ±50% (rates + token split assumed); Phase 1 closure subset ~$0.62, wallet-import subset ~$1.20, Story 11 subset ~$0.65, testcontainers subset ~$0.95, Story 5 (PR #122) subset ~$2.25, Story 6 (PR #123) subset ~$1.05 |
