...
| **Total (retroactive est. + Phase 1 closure + wallet-import + Story 11 + testcontainers + Story 5 send)** | | **~3.42M** | **~1.14M** | | **~$20.62** | Subject to ±50% (rates + token split assumed); Phase 1 closure subset ~$0.62, wallet-import subset ~$1.20, Story 11 subset ~$0.65, testcontainers subset ~$0.95, Story 5 (PR #122) subset ~$2.25 |
