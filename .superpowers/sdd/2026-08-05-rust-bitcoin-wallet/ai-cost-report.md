...
| **Total (retroactive est. + Phase 1 closure + wallet-import + Story 11 + testcontainers + Stories 5/6/7/8 send + fee-rate + tx-list + fee-estimates)** | | **~4.25M** | **~1.39M** | | **~$23.72** | Subject to ±50% (rates + token split assumed); Phase 1 closure subset ~$0.62, wallet-import subset ~$1.20, Story 11 subset ~$0.65, testcontainers subset ~$0.95, Story 5 (PR #122) subset ~$2.25, Story 6 (PR #123) subset ~$1.05, Story 7 (PR #125) subset ~$1.10, Story 8 (PR #124) subset ~$0.95 |
