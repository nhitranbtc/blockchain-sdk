...
//!
//! Reads bundled `tokens/{mainnet,amoy}.json` via
//! `tests/common::load_token_registry(network)` + on-chain `decimals()`
//! verify in V6. The Polygon ERC-20 footgun: USDC (`0x3c499c542cef5e3811e1192ce70d8cc03d5c3359`,
